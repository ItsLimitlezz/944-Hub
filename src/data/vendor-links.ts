...
const ONLINE944 = (slug: string): VendorLink => ({
  vendor: '944online',
  url: `https://944online.com/${slug}/?searchid=321583&search_query=999`,
});
...
export const VENDOR_LINKS: Record<string, VendorLink[]> = {
  ...
  // Oil pressure relief valve o-ring (upper) — two numbers, one product
  '99970714640': [ONLINE944('oil-pressure-relief-valve-o-ring-upper-82-95')],
  '99970714440': [ONLINE944('oil-pressure-relief-valve-o-ring-upper-82-95')],
