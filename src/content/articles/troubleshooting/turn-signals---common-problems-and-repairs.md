---
title: "Troubleshooting - Electrical (including Instruments)"
...
***- [On my late model 944, the wipers, blower motor, reverse lights, cooling fans, power windows, and power mirrors all quit working.](#misc)
- [Dash lights are too dim.](#dim)
- [Rear defroster does not work.](#defrost)
- [Battery goes dead after a short period of time.](#battery)
- [Fuse #11 Blown (1985 through 1989 944, 944S, 944S2, 944 Turbo)](#fuse)
- [One of my instrument panel gauges is not working properly.](#gauge)
- [My turn signal blinks faster on one side than the other.](#signal-fast)***- ***[My turn signal light comes on but does not blink.](#signal-blink)***
...
- **Flaking of instrument bezel reflective coating, burned out bulbs, or bulb wattage too low** — Refer to Instrument Panel Light procedure. → [ELECT-08](https://www.clarks-garage.com/shop-manual/elect-08.htm)

## Rear Defroster Doesn't Work

- **Damaged lug, damaged grid, loss of power** — Refer to Rear Hatch Defroster Troubleshooting and Repair procedure. → [ELECT-05](/manual/electrical/rear-hatch-defroster-troubleshooting)

## Battery goes dead after a short period of time.

- **Possible ground on electrical system** — Use the Excessive Battery Discharge Rate procedure to try and isolate the problem. → [ELECT-26](/manual/electrical/excessive-battery-discharge-rate)
...
- **Faulty gauge, sensor, or wiring** — Troubleshoot using Sensors and Gauges procedure. → [ELECT-19](/manual/electrical/gauge-troubleshooting)
