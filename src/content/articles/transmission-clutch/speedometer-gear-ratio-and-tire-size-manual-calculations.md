...
Use the following formula to determine tire circumference:

![Tire Circumference Formula](/articles/speedometer-gear-ratio-and-tire-size-manual-calculations/circ1-1.gif)
...
![Circumference Formula](/articles/speedometer-gear-ratio-and-tire-size-manual-calculations/circ3-1.gif)

Substituting for the tire size in the example:

![Example Tire Size Formula](/articles/speedometer-gear-ratio-and-tire-size-manual-calculations/circ2-1.gif)

To determine the speed in MPH for a given gear ratio use the following formula:

![Speed Formula](/articles/speedometer-gear-ratio-and-tire-size-manual-calculations/speed1-1.gif)

So, the calculated speed for a 1983 944 in 5th gear at 6400 RPM with 225/50 VR 16 tires would be:

![Example Speed](/articles/speedometer-gear-ratio-and-tire-size-manual-calculations/speed2-1.gif)
