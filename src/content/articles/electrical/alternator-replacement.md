...
Replacing the alternator in a 944 is not extremely difficult. However, it is somewhat time consuming since a large number of parts have to be removed to actually get to the alternator.
