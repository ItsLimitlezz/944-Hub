...
A single place to look up the fasteners you'll meet on a 944, 944 Turbo, 924S or 968. The specs here are pulled from the individual repair guides — each section links back to the procedure it came from, where you'll find the full context, tools and sequence.

> **Before you reach for the torque wrench.** Values vary by model year and by whether a fastener is reused — always confirm against the specific procedure for your car. Where the original gave only one unit, the converted value is marked with **≈**. Angle-tightening (e.g. *+60°*) means turn the fastener the stated angle *after* the initial torque, using a paint mark to track it.

## General fastener torque

When a specific value isn't called out, these are the default torques by thread size:

| Thread size | Torque |
| --- | --- |
| 6 mm | 8 Nm (6 ft-lb) |
| 8 mm | 20 Nm (15 ft-lb) |
| 10 mm | 40 Nm (29 ft-lb) |

## Cylinder head

Head **bolts** are not a single value — they use a staged torque-plus-angle procedure that differs by engine (M44 variant). Use the dedicated guide for the correct sequence and figures for your car.
...
| Cam sprocket retaining collar bolt — cheesehead | M10 × 65 mm | 65–70 Nm (48–52 ft-lb) |
| Cam sprocket retaining collar bolt — hex head | M10 | 45 Nm (33 ft-lb) |
| Distributor housing retaining bolts | M6 | 8 Nm (6 ft-lb) |
| Cam cover / lifting ring bolts | M6 × 22 mm | 8 Nm (6 ft-lb) |
...
| Fastener | Size | Torque |
| --- | --- | --- |
| Water pump nuts & bolts | — | 8 Nm (6 ft-lb) |
...
| Clutch pivot shaft retaining screw | — | 9.5 Nm (7 ft-lb) |
| Clutch pivot shaft locking nut | — | 7.5 Nm (6 ft-lb) |
...
| CV joint bolts (to transaxle) | — | 41 Nm (30 ft-lb) |
...
| Fastener | Size | Torque |
| --- | --- | --- |
| Cross-member mounting bolts | M12 · 19 mm socket | 85 Nm (63 ft-lb) |
...
| Ball joint to steering knuckle lock nut | M10 | 50 Nm (37 ft-lb) |
| Front strut cartridge cap | — | 150 Nm ±30 (111 ±22 ft-lb) |
| Front strut top bearing retaining nut | — | 77 Nm (57 ft-lb) |
| Sway bar / linkage to body bolts | M8 | 23 Nm (17 ft-lb) |
| Sway bar to control arm — steel arms | — | 23 Nm (17 ft-lb) |
| Sway bar to control arm — aluminum arms | — | 25 Nm (18 ft-lb) |
| Rear axle (hub) nut — steel trailing arm | — | 350 ft-lb (≈475 Nm) |
| Rear axle (hub) nut — aluminum trailing arm | — | 500 Nm (368 ft-lb) |
...
| Steering rack mounting bolts | — | 23 Nm (17 ft-lb) |
| Steering rack clamp bolts | — | 17 ft-lb (≈23 Nm) |
