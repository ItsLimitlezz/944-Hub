...
Factory option (M-code) numbers for the Porsche 944. These codes appear on the option sticker (in the front trunk / service booklet) and identify how the car was originally equipped.
...
| `C77` | Not Available |
| `F75` | Not Available |
| `R01` | Touring package (Not available with airbags) |
| `R74` | Touring package |
| `009` | Sport-o-matic transmission |
| `018` | Leather steering wheel-raised 380mm hub (Not available with airbags) |
| `020` | Speedometer with two scales (MPH/KPH) |
...
| `258` | Heated mirror |
| `261` | Electric mirror-Passenger side |
| `262` | Manual mirror-Passenger side |
| `277` | Version for Switzerland |
| `286` | High intensity windshield washer |
...
| `330` | Radio Blaupunkt "Toronto" (not for USA) |
...
| `383` | Sport seat-left, with electrical height adjustment |
| `387` | Sport seat-right, with electrical height adjustment |
| `389` | Porsche car radio-type US |
| `391` | Stone guard foil, added separately |
| `393` | Forged alloy wheels 8/9 X 16 (944/944S/951) |
| `394` | Pressure cast magnesium rims (944/944S/951) |
| `395` | 16" Forged alloy wheels (944/944S/951) |
| `396` | Wheel - 8J X 15 (rear) "Phone dials" |
...
| `475` | License plate fastening (version for Austria, Finland, and Australia) |
...
| `487` | Connection for fog head lamp with parking light |
...
| `503` | Cabriolet variant (Speedster) |
| `505` | Slant nose |
| `513` | Lumbar support - right seat |
| `525` | Alarm with continuous sound |
| `526` | Door panels covered with cloth |
...
| `559` | Air conditioner |
| `560` | Detachable roof |
| `562` | Driver's side airbag |
| `563` | Passenger's side airbag |
...
| `568` | Tinted windshield, side and rear glass (heated rear glass)(1978-1982) |
...
| `622` | Differing parts for cars with 2 valve engine |
| `637` | Sport group |
...
| `680` | Digital sound |
| `684` | One piece rear seat |
| `685` | Divided rear seat |
| `686` | Radio "Ludwigsburg" - SQM with arimat |
| `688` | Radio Blaupunkt "Boston" - SQM 26, ARI |
...
| `925` | Version for high altitude areas in the USA |
